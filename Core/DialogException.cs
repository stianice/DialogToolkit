...
public class DialogException : Exception
{
    ...
    /// </summary>
    public const string HostPageIsNotDialogHost =
        "The current page is not currently hosting a Dialog";
    ...
    /// </summary>
    public const string UnableToSetTheDialogCloseListener =
        "Unable to locate the backing field or setter for IDialogAware.RequestClose";
