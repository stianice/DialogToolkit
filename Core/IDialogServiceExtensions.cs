...
public static class IDialogServiceExtensions
{
    ...
    /// <param name="dialogService">The <see cref="IDialogService"/>.</param>
    /// <param name="name">The name of the dialog</param>
    public static void ShowDialog(this IDialogService dialogService, Type name) =>
    ...
    public static void ShowDialog(this IDialogService dialogService, Type name, Action callback) =>
